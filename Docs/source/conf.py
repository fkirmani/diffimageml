...
sphinx_gallery_conf = {
    ...
    'doc_module': ('diffimageml',),  # documented module(s)
...
htmlhelp_basename = 'diffimageml'+'doc'
...
latex_documents = [
    (master_doc, 'diffimageml'+'.tex', 'diffimageml'+' Documentation',
     'Steve Rodney', 'manual'),
]
...
man_pages = [
    (master_doc, 'diffimageml', 'diffimageml'+' Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'diffimageml', 'diffimageml'+' Documentation',
     author, 'diffimageml', 'One line description of project.',
     'Miscellaneous'),
]
